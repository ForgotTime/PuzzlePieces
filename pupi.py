...
IMAGE_DIR = getattr(settings, "IMAGE_DIR")
'''配置类'''
class Config():
    # 根目录
    image_dir = IMAGE_DIR
    ...
    # 字体路径
    FONT_PATHS_DICT = {
        '1/4screenwidth': {'name': os.path.join(rootdir, 'base/resources/fonts/simkai.ttf'), 'size': SCREENSIZE[0] // 4},
        '1/15screenwidth': {'name': os.path.join(rootdir, 'base/resources/fonts/simkai.ttf'), 'size': SCREENSIZE[0] // 15},
        '1/20screenwidth': {'name': os.path.join(rootdir, 'base/resources/fonts/simkai.ttf'), 'size': SCREENSIZE[0] // 20},
    }
